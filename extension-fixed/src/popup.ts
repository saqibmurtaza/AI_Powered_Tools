...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    // Also update the updateCardSelection function to ensure immediate UI update:
    async function updateCardSelection(cardId: string, selected: boolean): Promise<void> {
        const cards = await getCardsFromStorage();
        const cardIndex = cards.findIndex(c => c.id === cardId);
    ...
    // Update the updateButtonStates function to be more robust:
    async function updateButtonStates(): Promise<void> {
        try {
            const cards = await getCardsFromStorage();
            const selectedCount = cards.filter(card => card.selected).length;
    ...
    //                 // Export all cards
    //                 cardsToExport = cards;
    //                 summaryToExport = ''; // Don't include collective summary for all cards
    //                 break;
    //             case '4':
    //             case '5':
    //             case '6':
    ...
    //                 summaryToExport = collectiveSummary; // Include collective summary for selected cards
    //                 break;
    //             default:
    //                 cardsToExport = cards;
    //                 summaryToExport = '';
    ...
    //             case '1':
    //             case '4':
    //                 exportAsStructuredDocument(cardsToExport, summaryToExport);
    //                 break;
    //             case '2':
    //             case '5':
    //                 exportAsHTML(cardsToExport, summaryToExport);
    //                 break;
    //             case '3':
    //             case '6':
    //                 exportAsJSON(cardsToExport, summaryToExport);
    //                 break;
    //             default:
    //                 exportAsStructuredDocument(cardsToExport, summaryToExport);
    //         }

    //         showNotification(`Exported ${cardsToExport.length} cards`, 'success');
    //     });
    // }
    ...
    // Update the export functions to accept exportScope parameter:
function exportAsStructuredDocument(cards: Card[], collectiveSummary: string, exportScope: string): void {
    ...
    //     if (cards.length !== sortedCards.length) {
    //         document += `**Export Scope:** Selected Cards Only (${cards.length} of ${sortedCards.length} total)\n`;
    //     }
    ...
    // Update the document generation functions to handle export scope:
